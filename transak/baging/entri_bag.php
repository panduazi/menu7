 ...
 $bagawal=date('mdhis');
  ...
  if (isset($_POST['btsavebag'])) {
	  ...
	  if ($_SESSION['MM_nobag'] != 'NA#') {
	   ...
	   $q = "INSERT IGNORE INTO tblmanifest (ManifestNo, ManifestDate, ManifestReff, ManifestFromCity, ManifestToCity, ManifestWeight,RecId1,RecId2,CreateBy,ModiBy) VALUES ('".$n."','".$tgl2."','".$office."','". $location."','".$c."','".$b."',now(),now(),'".$cuser."','".$cuser."')";	
	   ...
	   //insert ke detail manifest
    	...
    	while ($r = mysql_fetch_array($sql)) {
		 ...
		 $result2=@mysql_query("insert into tblmanifestdetail(ManiDtlNo, ManiDtlConnoteNo) values('$n', '$tawb')");	
		}
   	   //cetak manifest
...
<body>
 ...
 <form action="fmenu.php?hal=bagdtl" method="post" enctype="multipart/form-data"  onsubmit="return cekform()">
 <table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td width="14%">Nomor Baging</td>
    <td width="72%"><input type="text" name="nobag" /> 
      <span style="font-size:10px">*Kosongan untuk penomoran otomatis</span></td>
    <td width="7%">&nbsp;</td>
    <td width="7%">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><span style="margin:10px">
      <input type="submit" name="btcreate" id="btcreate" value="Create New Manifest" />
