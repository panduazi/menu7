...
<tr>
    ...
    <td><div class="jud_tabel">Tujuan</td>
    <td><div class="jud_tabel">No. SMU</td>
...
<?php
	...
	$sql = mysql_query("SELECT * FROM tblmanifest left join tblcity on ManifestToCity=CityId where ManifestFromCity=$location order by ManifestNo DESC LIMIT 20 ");
	$i=1;
	while ($row=mysql_fetch_array($sql))
	{
		$nbrt=number_format($row[ManifestWeight],1);
            ...
            echo "<td align='center'><a href='transak/baging/print_manifes.php?nobag=".$row[ManifestNo]."' target='_blank'>Print</a></td>";
      		echo "</tr>";
	  		$i++;
	  	}
	?>
