...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td colspan="3">Pjng : <? echo $vol1; ?> X <? echo $vol2; ?> X <? echo $vol3; ?> cm = <? echo $brtvol; ?> Kg.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="center" colspan="4" rowspan="2">Dengan menanda tangani lembar ini, pelanggan sudah membaca memahami syarat2 pengirman. Untuk melihat pergerakan barang/tracking dapat melihat pada www.sagaprima.com </td>
  </tr>  
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>Keterangan isi :</td>
    <td colspan="3">: <? echo $vol1; ?> X <? echo $vol2; ?> X <? echo $vol3; ?> cm = <? echo $brtvol; ?> Kg.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2"><? echo $refcust; ?></td>
  ...
  <tr>
    ...
    <td colspan="2">: <? echo $vol1; ?> X <? echo $vol2; ?> X <? echo $vol3; ?> = <? echo $brtvol; ?> Kg.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
