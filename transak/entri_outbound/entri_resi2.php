...
<!-- <div id="er" class="easyui-panel" title="ENTRY AWB CREDIT" style="width:100%;height:500px;padding:5px;"> -->
  ...
  <tr>
    <td>&nbsp;</td>
    <td>No. AWB</td>
    <td><input name="noresi" type="text"  id="noresi" class="easyui-numberbox" data-options="required:true"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Pelanggan</td>
    <td><select name="nmcust" id="nmcust" class="easyui-combobox" data-options="prompt:'pilih'" >
      <?php 
    	  include('config/koneksi.php'); 
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Kota tujuan</td>
    <td><select name="cbdest" id="cbdest" class="easyui-combobox" data-options="prompt:'pilih'">
      <?php 
    	  include('config/koneksi.php'); 
...
Koli/Qty
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="button" name="btsave" id="btsave" value="Save/Rekam"/>      <input type="button" name="btcancel" id="btcancel" value="Reset/Clear" onclick="clearForm()" /></td>
    <td>&nbsp;</td>
  </tr>
   </table>
