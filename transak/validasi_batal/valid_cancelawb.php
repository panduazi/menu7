<?php
 ...
 // --- jika tekan TOMBOL CARI 
  if (isset($_POST['btsave'])) {
	...
	//ubah connote
	$q = "UPDATE tblconnote SET ConnoteValid=-1, ConnoteRecId2=now(), ConnoteModiBy='$cuser' WHERE ConnoteNo='$noawb'";
  	include('config/koneksi.php');	
	...
	$cnocp=9;
	$cjam=date("G:i:s");
	$cdesc='AWB DIBATALKAN/DIHAPUS oleh '.$cuser;
	$q1 = "INSERT INTO tbltrackingstatus(StatusKonosNo, StatusPOD, StatusDesc, StatusOffice, StatusLocation, StatusDate, StatusJam, RecId, ModiBy) VALUES ('".$noawb."','".$cnocp."','".$cdesc."','".$office."','".$location."','".$tglskr."','".$cjam."',now(),'".$cuser."')";
  	include('config/koneksi.php');	
...
<body>
    <div style="margin:10px">
     ...
     <form action="fmenu.php?hal=cancel" method="post">
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td width="65%" style="font-size:16px;"><h1>Batal/Hapus Connote/AWB</h1></td>
     ...
     <form action="fmenu.php?hal=cancel" method="post" onsubmit="return cekform()">
      <table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td>No. AWB</td>
