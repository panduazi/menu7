...
header("Content-Disposition: attachment; filename=outbound_detail_moda.xls");
...
$office = $_SESSION['coffice'];
 ...
 $sql = mysql_query("SELECT ConnoteNo,ConnoteDate,CustomerSales,CustomerName,CityName,CityProvinsi,ServiceCode,
                    ConnoteQty,ConnoteWeight,ConnoteBillAmount-ConnoteBillDisc as NilaiJual,ManifestMAWBNo,ManifestAirline,ManifestDest                         
                    from tblConnote 
                    left join tblAirLineSMU_AWB on ConnoteNo=AWBNo
