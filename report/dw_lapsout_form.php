...
<body>
<form action="report/dw_lapsout_isi.php" method="post" onsubmit="return cekform()">
	<table width="100%" border="0" cellspacing="0" cellpadding="1">
  	<tr>
    	<td style="font-size:16px" colspan="3"><h2>Download Status Outbound</h2></td>
    </tr>
  	<tr>
    	<td colspan="3"><hr></td>
    </tr>
  	...
  	<tr>
    	...
    	<td><select name="cbcust" id="cbcust">
		  ...
		  $sales=mysql_query("select CustomerNo,CustomerName from tblCustomer where CustomerCategory=2 order by CustomerName ",$koneksi);
