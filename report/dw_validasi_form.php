...
<body>
<form action="report/dw_validasi_isi.php" method="post" onsubmit="return cekform()">
	<table width="100%" border="0" cellspacing="0" cellpadding="1">
  	<tr>
    	<td style="font-size:16px" colspan="3"><h2>Download Data Hasil VALIDASI</h2></td>
    </tr>
  	<tr>
    	<td colspan="3"><hr></td>
    </tr>
...
<!--    <tr>
      ...
      <td><select name="cbisi" id="cbisi">
          <option value='0'>-- all --</option>        
          <option value='1'>Belum divalidasi</option>        
          <option value='2'>Belum ditagihkan</option>        
      </select></td>
    </tr>
-->    
