...
<body>
<form action="report/up_awb_odisys_isi.php" method="post" onsubmit="return cekform()">
	<table width="100%" border="0" cellspacing="0" cellpadding="1">
  	<tr>
    	<td style="font-size:16px" colspan="3"><h2>Upload Data AWB ke Servcer Odisys</h2></td>
    </tr>
  	<tr>
    	<td colspan="3"><hr></td>
    </tr>
  	...
  	<tr>
    	<td><input type="submit" name="btcari" id="btcari" value="Proses UPLOAD mulai"></td>
    	<td>&nbsp;</td>
    	<td>&nbsp;</td>
   	</tr>
	</table>
