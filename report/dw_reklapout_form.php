...
<body>
<form action="report/dw_reklapout_isi.php" method="post" onsubmit="return cekform()">
	<table width="100%" border="0" cellspacing="0" cellpadding="1">
  	<tr>
    	<td style="font-size:16px" colspan="3"><h2>Download Data Rekap Outbound per Customer</h2></td>
    </tr>
  	<tr>
    	<td colspan="3"><hr></td>
    </tr>
  	<tr>
    	<td width="11%">Mulai tgl</td>
   	  <td width="100%"><input name="tgl1" type="text" class="easyui-datebox" id="tgl1" value="<? echo $tgl1 ?>" size="12" data-options="formatter:myformatter,parser:myparser"></td>
    	<td width="18%">&nbsp;</td>
   	  </tr>
  	<tr>
    	<td>hingga</td>
