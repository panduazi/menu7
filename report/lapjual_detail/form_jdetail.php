...
<body>    
  <div style="margin:10px;">
    ...
    <h2>Laporan penjulan detail per pelanggan</h2>
    <hr>
      ...
      <tr>
          ...
          <input name="tgl1" id="tgl1" type="text" class="easyui-datebox" data-options="
            ...
            <input name="cbcust" id="cbcust" class="easyui-combobox" size="30" data-options="                               
                ...
                url:'report/lapjual_detail/get_cust.php',
                method:'get',
	...
	<table id="dg" class="easyui-datagrid" style="width:100%;height:480px"
			url="report/lapjual_detail/get_data.php"
		  pagination="true" 
        ...
        <th field="NILAI" align="right">NILAI Rp.</th>
			</tr>
		</thead>
	</table>	
  ...
  ?>
    ...
    function get_data(){
      ...
      var url = 'report/lapjual_detail/get_data.php?date1='+tgl1+'&date2='+tgl2+'&cust='+cust;
      console.log(url);
    ...
    function excel_data(){
      ...
      var cust = $("#cbcust").combobox('getValue');      
      // var cust = $("#nocust").val();  
      var url = 'report/lapjual_detail/excel.php?date1='+tgl1+'&date2='+tgl2+'&cust='+cust;
      window.open(url);
