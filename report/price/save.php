...
$sql = "insert into tblprice(PriceCityId, PriceCityCode, PriceSDS1, PriceONS1, PriceREG1, PriceTRUCK1, PriceTRUCK2, PriceTRUCK3, PriceTRUCK4, PriceTRUCK5, PriceTRUCK6, PriceTRUCK7, PriceTRUCK8, PriceSEA1, PriceSEA2, PriceSEA3, PriceSEA4, PriceSEA5) values($CityName, '$office', $sds,$ons,$reg, $truk1,$truk2, $truk3, $truk4, $truk5, $truk6, $truk7, $truk8, $sea1, $sea2, $sea3, $sea4, $sea5)";
