...
<body>
<form action="report/dw_lapsmu_isi2.php" method="post" onsubmit="return cekform()">
	<table width="100%" border="0" cellspacing="0" cellpadding="1">
  	<tr>
    	<td style="font-size:16px" colspan="3"><h2>Download Data SMU Detail Connote/AWB</h2></td>
    </tr>
  	<tr>
    	<td colspan="3"><hr></td>
    </tr>
